...
This package provides the [Simple Icons 16.10.0](https://github.com/simple-icons/simple-icons/releases/tag/16.10.0) packaged as a set of [Svelte](https://svelte.dev/) components.
