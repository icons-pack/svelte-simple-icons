...
This package provides the [Simple Icons 2.14.0](https://github.com/simple-icons/simple-icons/releases/tag/2.14.0) packaged as a set of [Svelte](https://svelte.dev/) components.
