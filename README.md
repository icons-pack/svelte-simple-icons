...
This package provides the [Simple Icons 15.6.0](https://github.com/simple-icons/simple-icons/releases/tag/15.6.0) packaged as a set of [Svelte](https://svelte.dev/) components.
