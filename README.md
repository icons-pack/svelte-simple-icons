...
This package provides the [Simple Icons 2.17.1](https://github.com/simple-icons/simple-icons/releases/tag/2.17.1) packaged as a set of [Svelte](https://svelte.dev/) components.
